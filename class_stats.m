function classifstat = class_stats(correctClass, estimatClass, evalalpha)
% Calculate classification statistics to analyze the quality of a 
...
classifstat.auc = auc(correctClass, estimatClass);
...
% Calculate conditional probabilities of an observation being in either
% class. Use Laplace (+1) smoothing. The 2 in the denominator comes from 
% there being two cases to differentiate.
% (This is used for the Bernoulli Naive Bayes model where each row is a 
% token.)
